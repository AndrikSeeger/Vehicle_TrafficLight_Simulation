...
static void initClass_ROOT_PC_PC_5_(ROOT_PC_PC_5__Class *self)
{
    self->ASCET_TOP_Ptr = (struct L1_PC_PC_5__Obj*) initInstance_L1_PC_PC_5_();
}

static ASDClassHeader ROOT_ClassHeader_PC_PC_5_ = {0, 0, 0, 1, (MethodList *)0, (MethodList *)0};
static ROOT_PC_PC_5__Class ROOT_PC_PC_5__ClassObj = {{1, {&ROOT_ClassHeader_PC_PC_5_}, {0}}};

/* Initialization from root node of model */
ASDObject *initializeRoot_PC_PC_5_(void)
{
	struct ROOT_PC_PC_5__Obj *self = 0;

	initClass_ROOT_PC_PC_5_(&ROOT_PC_PC_5__ClassObj);
	CREATE_OBJECT(self, ROOT_PC_PC_5_);
...
{
    return initializeRoot_PC_PC_5_();
}
